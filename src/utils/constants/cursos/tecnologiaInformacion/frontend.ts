...
export const FRONTEND_JUMBOTRON: JumbotronProps = {
    topTitle: "Programación",
    bottomTitle: "Web FrontEnd",
    imagePath: "/images/cursos/ti/frontend/HERO_IMG.jpg",
};

export const FRONTEND_NAV_LINKS: string[] = [
    "TECNOLOGÍAS DE LA INFORMACIÓN",
    "PROGRAMACIÓN WEB FRONTEND",
];

export const FRONTEND_DESCRIPTION = {
    courseName: "PROGRAMACIÓN WEB FRONTEND",
    courseDescription:
...
export const FRONTEND_OBJECTIVES_CONTENT: CourseObjectivesContentType =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in nisl in ligula condimentum pulvinar. Praesent mattis, ipsum eu ullamcorper suscipit, massa dui lacinia massa, ac bibendum lorem dolor et mauris. Curabitur laoreet mollis arcu, a interdum turpis sodales sed. Ut vel egestas tortor";

export const FRONTEND_SCHEDULES = {
    daytimeSchedule: "7:00 a.m. - 10:45 a.m.",
    afternoonSchedule: "15:00 p.m. - 18:45 p.m.",
    nightSchedule: "19:00 p.m. - 22:45 p.m.",
};

export const FRONTEND_CYCLES: CourseCyclesProps[] = [
    {
        number: 1,
        courses: [
            "MATEMÁTICA BÁSICA",
