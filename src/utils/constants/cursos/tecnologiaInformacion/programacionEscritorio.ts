...
export const DESK_PROGRAMMING_JUMBOTRON: JumbotronProps = {
    topTitle: "Programación de",
    bottomTitle: "Aplicaciones de Escritorio",
    imagePath: "/images/cursos/ti/programacion-escritorio/HERO_IMG.jpg",
};

export const DESK_PROGRAMMING_NAV_LINKS: string[] = [
    "TECNOLOGÍAS DE LA INFORMACIÓN",
    "PROGRAMACIÓN DE APLICACIONES DE ESCRITORIO",
];

export const DESK_PROGRAMMING_DESCRIPTION = {
    courseName: "PROGRAMACIÓN DE APLICACIONES DE ESCRITORIO",
    courseDescription:
...
export const DESK_PROGRAMMING_OBJECTIVES_CONTENT: CourseObjectivesContentType =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in nisl in ligula condimentum pulvinar. Praesent mattis, ipsum eu ullamcorper suscipit, massa dui lacinia massa, ac bibendum lorem dolor et mauris. Curabitur laoreet mollis arcu, a interdum turpis sodales sed. Ut vel egestas tortor";

export const DESK_PROGRAMMING_SCHEDULES = {
    daytimeSchedule: "7:00 a.m. - 10:45 a.m.",
    afternoonSchedule: "15:00 p.m. - 18:45 p.m.",
    nightSchedule: "19:00 p.m. - 22:45 p.m.",
};

export const DESK_PROGRAMMING_CYCLES: CourseCyclesProps[] = [
    {
        number: 1,
        courses: [
            "MATEMÁTICA BÁSICA",
