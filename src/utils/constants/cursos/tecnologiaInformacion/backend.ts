...
export const BACKEND_JUMBOTRON: JumbotronProps = {
    topTitle: "Programación",
    bottomTitle: "BackEnd",
    imagePath: "/images/cursos/ti/backend/HERO_IMG.jpg",
};

export const BACKEND_NAV_LINKS: string[] = [
    "TECNOLOGÍAS DE LA INFORMACIÓN",
    "PROGRAMACIÓN BACKEND",
];

export const BACKEND_DESCRIPTION = {
    courseName: "PROGRAMACIÓN BACKEND",
    courseDescription:
...
export const BACKEND_OBJECTIVES_CONTENT: CourseObjectivesContentType =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in nisl in ligula condimentum pulvinar. Praesent mattis, ipsum eu ullamcorper suscipit, massa dui lacinia massa, ac bibendum lorem dolor et mauris. Curabitur laoreet mollis arcu, a interdum turpis sodales sed. Ut vel egestas tortor";

export const BACKEND_SCHEDULES = {
    daytimeSchedule: "7:00 a.m. - 10:45 a.m.",
    afternoonSchedule: "15:00 p.m. - 18:45 p.m.",
    nightSchedule: "19:00 p.m. - 22:45 p.m.",
};

export const BACKEND_CYCLES: CourseCyclesProps[] = [
    {
        number: 1,
        courses: [
            "MATEMÁTICA BÁSICA",
