...
export const PHOTO_RETOUCH_JUMBOTRON: JumbotronProps = {
    topTitle: "Diseño de",
    bottomTitle: "Retoque Fotográfico",
    imagePath: "/images/cursos/diseño/diseño-retoque-fotografico/HERO_IMG.jpg",
};

export const PHOTO_RETOUCH_NAV_LINKS: string[] = [
    "DISEÑO",
    "DISEÑO DE RETOQUE FOTOGRÁFICO",
];

export const PHOTO_RETOUCH_DESCRIPTION = {
    courseName: "DISEÑO DE RETOQUE FOTOGRÁFICO",
    courseDescription:
...
export const PHOTO_RETOUCH_OBJECTIVES_CONTENT: CourseObjectivesContentType =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in nisl in ligula condimentum pulvinar. Praesent mattis, ipsum eu ullamcorper suscipit, massa dui lacinia massa, ac bibendum lorem dolor et mauris. Curabitur laoreet mollis arcu, a interdum turpis sodales sed. Ut vel egestas tortor";

export const PHOTO_RETOUCH_SCHEDULES = {
    daytimeSchedule: "7:00 a.m. - 10:45 a.m.",
    afternoonSchedule: "15:00 p.m. - 18:45 p.m.",
    nightSchedule: "19:00 p.m. - 22:45 p.m.",
};

export const PHOTO_RETOUCH_CYCLES: CourseCyclesProps[] = [
    {
        number: 1,
        courses: [
            "MATEMÁTICA BÁSICA",
