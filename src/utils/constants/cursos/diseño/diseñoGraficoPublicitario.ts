...
export const GRAPHIC_DESIGN_JUMBOTRON: JumbotronProps = {
    topTitle: "Diseño Gráfico",
    bottomTitle: "Publicitario",
    imagePath: "/images/cursos/diseño/diseño-grafico-publicitario/HERO_IMG.jpg",
};

export const GRAPHIC_DESIGN_NAV_LINKS: string[] = [
    "DISEÑO",
    "DISEÑO GRÁFICO PUBLICITARIO",
];

export const GRAPHIC_DESIGN_DESCRIPTION = {
    courseName: "DISEÑO GRÁFICO PUBLICITARIO",
    courseDescription:
...
export const GRAPHIC_DESIGN_OBJECTIVES_CONTENT: CourseObjectivesContentType =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis in nisl in ligula condimentum pulvinar. Praesent mattis, ipsum eu ullamcorper suscipit, massa dui lacinia massa, ac bibendum lorem dolor et mauris. Curabitur laoreet mollis arcu, a interdum turpis sodales sed. Ut vel egestas tortor";

export const GRAPHIC_DESIGN_SCHEDULES = {
    daytimeSchedule: "7:00 a.m. - 10:45 a.m.",
    afternoonSchedule: "15:00 p.m. - 18:45 p.m.",
    nightSchedule: "19:00 p.m. - 22:45 p.m.",
};

export const GRAPHIC_DESIGN_CYCLES: CourseCyclesProps[] = [
    {
        number: 1,
        courses: [
            "MATEMÁTICA BÁSICA",
